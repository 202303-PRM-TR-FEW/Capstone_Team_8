...
function Home() {
  ...
  const buttons = [
    <div key="all" className="p-2 text-center">
      <button
        className={`border-2 rounded h-12 w-12 flex items-center justify-center ${
          selectedCategory === null ? "bg-gray-200" : ""
        }`}
        onClick={() => filterHandle(null)}
      >
        <svg className="h-8 w-8" viewBox="0 0 496 512" >
    ...
    <div key="animal" className="flex flex-col p-2 text-center justify-center items-center">
      <div>
        <button
        className={`border-2 rounded h-12 w-12 flex items-center justify-center ${
          selectedCategory === "Education" ? "bg-gray-200" : ""
        }`}
        onClick={() => filterHandle("Education")}
      >
        <svg className="h-8 w-8" viewBox="0 0 640 512" >
    ...
    <div key="sport" className="flex flex-col p-2 text-center justify-center items-center">
      <div> <button
        className={`border-2 rounded h-12 w-12 flex items-center justify-center ${
          selectedCategory === "Culture" ? "bg-gray-200" : ""
        }`}
    ...
    <div key="education" className="flex flex-col p-2 text-center justify-center items-center">
      <div>
        <button
        className={`border-2 rounded h-12 w-12 flex items-center justify-center ${
          selectedCategory === "Animals" ? "bg-gray-200" : ""
        }`}
    ...
    <div key="denem1" className="flex flex-col p-2 text-center justify-center items-center">
      <div>
        <button
        className={`border-2 rounded h-12 w-12 flex items-center justify-center ${
          selectedCategory === "Children" ? "bg-gray-200" : ""
        }`}
        onClick={() => filterHandle("Children")}
      >
        <svg className="h-8 w-8" viewBox="0 0 384 512">
