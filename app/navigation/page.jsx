...
const Navigation = () => {
	...
	console.log(kickOffModalStatus);
					...
					<div className='flex flex-col lg:flex-row justify-evenly items-center w-full gap-12'>
						<div className='w-full flex justify-between flex-col gap-24'>
							...
							<div
								...
								className='w-full text-center cursor-pointer hover:text-[#d4ee26] hover:drop-shadow-sm border-b-2 lg:border-b-0 pb-4'
							>
								{/* <Link href='/myprojects'>
								<span className='text-3xl font-bold '>Kick-off</span> <br /> my
								project
							</Link> */}
								<button>
