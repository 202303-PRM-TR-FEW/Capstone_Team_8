		...
		<>
			...
			<div className='flex  flex-col  w-full overflow-auto  sm:pt-24 pt-12  pb-20 '>
				{filteredData.length < 1 ? (
					...
					<>
						<div className='flex flex-col md:justify-start md:items-start justify-center items-center sm:gap-4 sm:p-6 pt-12 p-2'>
							<div>
								<h1 className='font-bold sm:text-3xl text-center text-lg py-2'>
									{t('your_projects')}
								</h1>
							</div>
							<div>
								<p className='font-bold sm:text-lg text-sm text-center'>
