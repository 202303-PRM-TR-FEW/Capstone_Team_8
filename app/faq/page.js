  ...
  return (
    <PageLayout>
      <div className="flex flex-col justify-center items-center py-24 gap-4 sm:min-h-[95vh] min-h-[95svh] px-4 sm:px-6 ">
        ...
        development, and more. It is essential to choose a platform that aligns
        with your project type. <br />
        ...
        risks, and projects may not always deliver as planned. <br />
        ...
        terms. In some cases, backers may receive a refund if the funding goal
        is not met, while others might have a all-or-nothing policy. <br />
        Q6: How do I create a successful crowdfunding campaign? <br />
        A: To create a successful campaign, be clear about your projects
        purpose, set realistic funding goals, provide compelling rewards, and
        engage with your backers through regular updates. <br />
        ...
        selection before the campaign ends. Check the platforms guidelines for
        specific details. <br />
        ...
        there is always a possibility of delays or unforeseen challenges. If you
        encounter such issues, try to communicate with the project creator
        first. If necessary, contact the platforms support for further
        assistance. <br />
        Q9: Can I cancel my pledge during a crowdfunding campaign? <br />
        A: Yes, in most cases, backers can cancel their pledges before the
        campaign ends. However, double-check the platforms rules as they may
        vary. <br />
        ...
        allows backers to communicate with the project creator directly. You can
        use this feature to ask questions or seek additional information about
        the project. <br />
      </div>
    </PageLayout>
  );
