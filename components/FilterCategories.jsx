		...
		<>
			<div className='flex'>
				<div key='all' className='p-2 text-center'>
					<button
						className={`border-2 rounded sm:h-12  sm:w-12 w-8 h-8 flex items-center justify-center ${
							selectedCategory === null ? 'bg-gray-200' : ''
						}`}
						onClick={() => filterHandle(null)}
					>
						<svg className='sm:h-8 sm:w-8 h-6 w-6' viewBox='0 0 496 512'>
				...
				<div
					key='animal'
					className='flex flex-col p-2 text-center justify-center items-center'
				>
					<div>
						<button
							className={`border-2 rounded sm:h-12 sm:w-12 w-8 h-8 flex items-center justify-center ${
						...
						>
							<svg className='sm:h-8 sm:w-8 h-6 w-6' viewBox='0 0 640 512'>
				...
				>
					<div>
						...
						>
							<svg className='sm:h-8 sm:w-8 h-6 w-6' viewBox='0 0 512 512'>
				...
				>
					<div>
						...
						>
							<svg className='sm:h-8 sm:w-8 h-6 w-6' viewBox='0 0 384 512'>
