...
function FilterCategories({
  ...
  return (
    <>
      <div className='flex text-sm sm:text-base md:text-md lg:text-lg max-w-sm sm:max-w-2xl'>
        <div key='all' className='p-2 text-center'>
          <button
            className={`border-2 rounded lg:h-12 lg:w-12 md:w-10 md:h-10 sm:w-8 sm:h-8 w-6 h-6 flex items-center justify-center ${
              selectedCategory === null ? "bg-gray-200" : ""
            }`}
            onClick={() => filterHandle(null)}
          >
            <svg
              className=' h-4 w-4 sm:h-6 sm:w-6 md:w-8 md:h-8 lg:h-10 lg:w-10 '
              viewBox='0 0 496 512'
            >
