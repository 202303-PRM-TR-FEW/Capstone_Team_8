									...
									<>
										<li onClick={loginHandler}>
											<button
												...
												className='block py-2  px-4 sm:px-8 w-full    bg-blue-600 text-white rounded  hover:drop-shadow-xl   '
											>
												{t('Login')}
											</button>
										</li>
										...
										<li>
											<button
												...
												className='block py-2 px-4 sm:px-8 w-full    bg-green-600 text-white rounded  hover:drop-shadow-xl   '
											>
												{' '}
												{t('register')}
											</button>
							...
							<div className='w-full p-4 md:p-0'>
								{auth.currentUser == null ? (
									<div className='flex flex-col gap-2'>
										<button
											onClick={registerHandle}
											className='block py-2 sm:py-4 px-4 sm:px-8 w-full text-lg sm:text-3xl  bg-green-600 text-white rounded  hover:drop-shadow-xl   '
										>
											{' '}
											{t('register')}
										</button>
